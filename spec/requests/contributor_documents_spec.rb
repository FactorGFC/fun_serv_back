...
RSpec.describe Api::V1::ContributorDocumentsController, type: :request do
  ...
  describe 'GET /contributors/:contributor_id/contributor_documents' do
    ...
    it 'manda los datos del documento' do
      ...
      expect(@contributor_document['attributes'].keys).to contain_exactly('id', 'name', 'status', 'notes', 'url', 'extra1', 'extra2', 'extra3', 'created_at', 'updated_at', 'contributor_id',
                                                                          'file_type_document_id')
    end
  end
