...
class CustomerCredit < ApplicationRecord
  ...
  def self.get_customer_credit_data(id)
    ...
    sta.name estado, mun.name municipio, cou.name pais,com.business_name nombre_empresa ,com.company_rate pertenece , com.start_date fecha_inicio_labores, com.sector giro_empresa,com.contributor_id company_contributor_id, cuc.insurance1 seguro, con.person_id person_id,
