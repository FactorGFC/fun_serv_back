...
class CustomerCredit < ApplicationRecord
  ...
  def self.get_customer_credit_data(id)
    ...
    sta.name estado, mun.name municipio, cou.name pais,com.business_name nombre_empresa , com.start_date fecha_inicio_labores, com.sector giro_empresa,com.contributor_id company_contributor_id, cuc.insurance1 seguro, con.person_id person_id,cus.public_charge ,cus.public_charge_det ,cus.relative_charge ,cus.relative_charge_det ,cus.benefit ,cus.benefit_detail ,cus.responsible ,cus.responsible_detail 
