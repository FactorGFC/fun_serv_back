...
def get_credit_customer_report
  ...
  lee.email pm_correo, lee.business_email pm_correo_negocio, lee.main_activity pm_actividad_pricipal, lee.fiel pm_fiel, coa.street calle, coa.suburb suburb, coa.external_number numero_exterior, coa.postal_code codigo_postal,
  sta.name estado, mun.name municipio, cou.name pais
